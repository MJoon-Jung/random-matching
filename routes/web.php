...
Route::group(['prefix'=>'/matching/video', 'middleware'=>['auth:sanctum', 'verified']], function () {
    Route::get('/', [VideoChatMatchingController::class, 'index'])->name('video-match.index');
    Route::get('/connect', [VideoChatMatchingController::class, 'connect'])->name('video-match.connect');
});
