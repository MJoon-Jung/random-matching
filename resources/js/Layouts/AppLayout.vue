                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('channel.index')" :active="route().current('channel.index')">
                                    채팅방
                                </jet-nav-link>
                            </div>
                        </div>
                            ...
                            <div class="ml-3 relative">
                                ...
                                <div class="flex justify-between">
                                    <div>
                                        ...
                                        <div class="text-xs text-red-500 ">{{ unreadNotificationsCount }}</div>
                                    </div>
                                    <button @click="createSearchUserModal" class="mr-2 text-sm">친구추가</button>
                                </div>
                                <NotifyModal v-if="showNotifyModal" :notifications="notifications"
                                             :show="showNotifyModal" :close="closeNotifyModal"/>
                                <SearchUserModal v-if="showSearchUserModal" :show="showSearchUserModal"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const getNotifications = () => {
            axios.get('/users/notification')
                .then((res) => {
                    ...
                    unreadNotificationsCount.value = res.data.unreadNotificationsCount;
                })
        ...
        return {
            ...
            switchToTeam, logout, showNotifyModal, createNotifyModal, closeNotifyModal, notifications, unreadNotificationsCount
        };
    },
})
</script>
